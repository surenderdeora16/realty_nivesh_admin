...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const tabs = [
    { name: 'General Setting', icon: MdOutlineDisplaySettings, path: '/settings/general-setting' },
    { name: 'SMS Service', icon: HiOutlineChatBubbleLeftRight, path: '/settings/sms-service' },
    { name: 'Email Service', icon: MdOutlineMailOutline, path: '/settings/email-service' },
    { name: 'Social Media', icon: IoShareSocialOutline, path: '/settings/social-media' },
  ]
